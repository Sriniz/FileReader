...
public class XLSXTOCSV {
    ...
    public class SheetToCSV implements SheetContentsHandler {
		...
		public String overriddenFormat(String cellRef, int formatIndex, String formatString) {
		       if (cellRef.matches("(H|I|R|S)\\d+")) { //matches all cells in H,I,R and S columns
		           return "yyyy-MM-dd;@"; //this is the date format in accepted by Salesforce data loader API
		       }
			return null;
		}
		*/
