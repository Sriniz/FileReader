...
public class XLSXTOCSV {
	...
	public class SheetToCSV implements SheetContentsHandler {
		...
		/*
		 * @Override public String overriddenFormat(String cellRef, int
		 * formatIndex, String formatString) { if
		 * (cellRef.matches("(H|I|R|S)\\d+")) { //matches all cells in H,I,R and
		 * S columns return "yyyy-MM-dd;@"; //this is the date format in
		 * accepted by Salesforce data loader API } return null; }
		 */
	}
	...
	public XLSXTOCSV(String parentId) {
	...
	public String xlsx2csvConverter(File xlsxFile) throws Exception {
		...
		XLSXTOCSV xlsx2csv = new XLSXTOCSV(p, ps, minColumns);
		xlsx2csv.process();
		p.close();
